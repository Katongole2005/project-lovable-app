    ...
    <>
      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between gap-4">
          ...
          <nav className={cn("hidden md:flex items-center gap-1 p-1.5 rounded-full", isDark ? "bg-white/10 backdrop-blur-xl border border-[#4ade80]/10 shadow-[0_2px_12px_rgba(74,222,128,0.08),inset_0_1px_0_rgba(255,255,255,0.1)]" : "")} style={!isDark ? { background: "#1c1c1e" } : undefined}>
            {navItems.map((item) => {
        ...
        <div className="md:hidden mt-4 flex justify-center">
          <nav className={cn("flex items-center gap-1 p-1.5 rounded-full", isDark ? "bg-white/10 backdrop-blur-xl border border-[#4ade80]/10 shadow-[0_2px_12px_rgba(74,222,128,0.08),inset_0_1px_0_rgba(255,255,255,0.1)]" : "")} style={!isDark ? { background: "#1c1c1e" } : undefined}>
            {navItems.map((item) => {
              const isActive = activeTab === item.id;
              return (
                <button
