...
const isDevelopment = () => {
  return self.location.hostname === "localhost" ||
         ...
         /^192\.168\.\d{1,3}\.\d{1,3}$/.test(self.location.hostname) ||
         /^10\.\d{1,3}\.\d{1,3}\.\d{1,3}$/.test(self.location.hostname) ||
         /^172\.(1[6-9]|2\d|3[0-1])\.\d{1,3}\.\d{1,3}$/.test(self.location.hostname) ||
