...
export function FilterModal({
  ...
  return (
    <div className="fixed inset-0 z-modal flex items-center justify-center p-4">
      ...
      <div
        className={cn(
          "absolute inset-x-3 top-6 bottom-6 md:relative md:inset-auto md:w-full md:max-w-lg md:h-[85vh] overflow-hidden transition-all duration-500 ease-out rounded-3xl",
      ...
      >
        ...
        <div className="absolute inset-0 pointer-events-none overflow-hidden rounded-3xl">
          ...
          <div
            className="absolute -top-20 -right-20 w-60 h-60 rounded-full bg-[#ff8a3d]/15 blur-3xl saturate-150 [animation:liquidFloat_8s_ease-in-out_infinite]"
          />
          <div
          ...
          />
          <div
            className="absolute -bottom-20 right-1/4 w-52 h-52 rounded-full bg-[#ff5b2e]/12 blur-3xl saturate-150 [animation:liquidFloat_12s_ease-in-out_2s_infinite]"
          />

          {/* Glass noise texture overlay */}
          <div
            className="absolute inset-0 opacity-[0.02] bg-[url('data:image/svg+xml,%3Csvg_viewBox=%270_0_200_200%27_xmlns=%27http://www.w3.org/2000/svg%27%3E%3Cfilter_id=%27noiseFilter%27%3E%3CfeTurbulence_type=%27fractalNoise%27_baseFrequency=%270.9%27_numOctaves=%271%27_stitchTiles=%27stitch%27/%3E%3C/filter%3E%3Crect_width=%27100%25%27_height=%27100%25%27_filter=%27url(%23noiseFilter)%27/%3E%3C/svg%3E')]"
          />
        </div>
        ...
        <div className="relative flex items-center justify-between px-5 py-4 border-b border-white/10">
          ...
          <button
            ...
            className={cn(
              ...
              hasActiveFilters
                ? "text-[#ffb36b] hover:text-[#ffd3a8] drop-shadow-[0_0_8px_rgba(255,138,61,0.35)]"
                : "text-white/50"
            )}
          >
            Clear all
        ...
        <div className="relative h-[calc(100%-140px)] overflow-y-auto px-5 py-6 space-y-8 scroll-smooth [&::-webkit-scrollbar]:w-1 [&::-webkit-scrollbar-track]:bg-transparent [&::-webkit-scrollbar-thumb]:bg-white/20 [&::-webkit-scrollbar-thumb]:rounded-full">
                ...
                return (
                  <button
                    ...
                    className={cn(
                      ...
                      isActive
                        ? "text-white border-transparent shadow-[0_10px_26px_rgba(255,91,46,0.22),0_0_22px_rgba(255,138,61,0.14)] font-bold bg-[linear-gradient(135deg,#ff8a3d_0%,#ff5b2e_52%,#ff4d6d_100%)]"
          ...
          <section className="space-y-4">
            <div className="flex items-center gap-2">
              ...
              <Sparkles className="w-4 h-4 text-[#ff8a3d] animate-pulse drop-shadow-[0_0_8px_rgba(255,138,61,0.45)]" />
            </div>
            <div className="flex flex-wrap gap-2">
        ...
        <div className="absolute bottom-0 left-0 right-0 p-4 bg-gradient-to-t from-black/30 via-black/10 to-transparent backdrop-blur-sm">
          <button
            ...
            className={cn(
              ...
              hasActiveFilters
                ? "text-white shadow-[0_10px_26px_rgba(255,91,46,0.24),0_0_22px_rgba(255,138,61,0.18),inset_0_1px_0_rgba(255,255,255,0.14)] bg-[linear-gradient(135deg,#ff8a3d_0%,#ff5b2e_52%,#ff4d6d_100%)]"
                : "bg-white/5 backdrop-blur-md border border-white/10 text-white/50"
            )}
          >
            Apply Filters
            {hasActiveFilters && (
              <span className="ml-2 inline-flex items-center justify-center w-5 h-5 rounded-full bg-white/20 text-xs text-white">
