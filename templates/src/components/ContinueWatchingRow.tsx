    ...
    <section className={cn("relative z-10 py-8", className)}>
      ...
      <div className="relative" bis_skin_checked="1">
        ...
        {canScrollLeft && (
          ...
          >
            <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 320 512" className="h-5 w-5" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
...
function ContinueWatchingCard({
  ...
  return (
    ...
    >
      ...
      >
        <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 352 512" className="h-3 w-3 sm:h-3.5 sm:w-3.5" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
      ...
      <div className="absolute bottom-0 left-0 z-20 w-full p-2.5 sm:p-3.5" bis_skin_checked="1">
        <div className="mb-2 flex items-center justify-between gap-2" bis_skin_checked="1">
          <div className="min-w-0" bis_skin_checked="1">
          ...
          <span className="inline-flex h-8 w-8 flex-shrink-0 items-center justify-center rounded-full border border-white/20 bg-white/12 text-white backdrop-blur-sm sm:h-9 sm:w-9">
            <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 448 512" className="ml-0.5 h-3 w-3 sm:h-3.5 sm:w-3.5" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
