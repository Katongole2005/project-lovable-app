    ...
    <>
      ...
      <header
        className={cn(
          ...
          hasAnnouncement 
            ? "md:top-[calc(env(safe-area-inset-top,0px)_+_3.5rem)]" 
            : "md:top-[calc(env(safe-area-inset-top,0px)_+_1.25rem)]"
        )}
      >
        <div className="pointer-events-auto relative z-10 flex items-center gap-2 rounded-full px-[14px] py-[10px] shadow-[0_8px_32px_rgba(0,0,0,0.25)]">
              ...
              <button
                ...
                className={cn(
                  ...
                  isActive
                    ...
                    : "text-white/85 hover:-translate-y-[1px] hover:scale-[1.01] hover:bg-white/12 hover:text-white hover:shadow-[0_6px_14px_rgba(0,0,0,0.2)]"
                )}
              >
          ...
          <button
            ...
            className={cn(
              "md:ml-1 inline-flex min-h-[40px] md:min-h-[44px] min-w-[40px] md:min-w-[44px] items-center justify-center rounded-full transition-all duration-200 hover:-translate-y-[1px] hover:scale-[1.01] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-violet-200/70 shrink-0",
              currentTab === "search"
                ? "bg-white/95 text-[#111] shadow-[0_8px_20px_rgba(0,0,0,0.26)]"
          ...
          <button
            ...
            className={cn(
              "ml-0.5 md:ml-1 inline-flex min-h-[40px] md:min-h-[44px] min-w-[40px] md:min-w-[44px] items-center justify-center rounded-full transition-all duration-200 hover:-translate-y-[1px] hover:scale-[1.01] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-violet-200/70 shrink-0",
              currentTab === "profile"
                ? "bg-white/95 text-[#111] shadow-[0_8px_20px_rgba(0,0,0,0.26)]"
                : "text-white/85 hover:bg-white/12 hover:text-white hover:shadow-[0_6px_14px_rgba(0,0,0,0.2)]"
            )}
