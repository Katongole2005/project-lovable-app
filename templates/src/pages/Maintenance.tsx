      ...
      >
        ...
        >
          ...
          <div className="relative flex items-center justify-center w-32 h-32">
            ...
            <div className="absolute" style={{ left: 0, top: 8, color: "#ff8a3d", opacity: 0.9 }}>
          ...
          <div className="flex items-center gap-2 pt-1">
            {[0, 1, 2].map((i) => (
              <div
                ...
                style={{ background: "#ff8a3d", animationDelay: `${i * 0.2}s` }}
              />
            ))}
          </div>
        </div>
        ...
        <button
          ...
          className="absolute bottom-6 text-xs opacity-20 hover:opacity-60 transition-opacity"
          style={{ color: "#666" }}
        >
          Admin
        </button>
